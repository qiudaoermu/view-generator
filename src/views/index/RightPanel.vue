    ...
    <div class="field-box">
      ...
      <el-scrollbar class="right-scrollbar">
        ...
        <el-form v-show="currentTab==='field' && showField" size="small" label-width="90px">
          ...
          <el-form-item v-if="activeData.style&&activeData.style.background!==undefined" label="组件颜色">
            <el-input v-model="activeData.style.background" placeholder="请输入组件颜色" clearable />
          </el-form-item>
          ...
          <el-form-item v-if="activeData.__vModel__!==undefined" label="src">
            <el-input
              :value="setDefaultValue(activeData.__config__.src)"
              placeholder="请输入默认值"
              @input="onImgSrcInput"
            />
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    onImgSrcInput(str) {
      if (isArray(this.activeData.__config__.src)) {
        // 数组
        this.$set(
          this.activeData.__config__,
          'src',
        ...
        // 布尔
        this.$set(this.activeData.__config__, 'src', JSON.parse(str))
      } else {
        // 字符串和数字
        this.$set(
          this.activeData.__config__,
